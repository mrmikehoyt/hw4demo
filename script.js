...
//above used for removing (hiding) answer buttons from main page
      ...
      prepareRead(); // code for starting timer // 
      ...
      //above is the code for displaying question 1
                  ...
                  GenerateBtn5.innerHTML = (wrongAnswers[3]);
                        ...
                        GenerateBtn4.innerHTML = (correctAnswers[3]);
                        ...
                        GenerateBtn4.innerHTML = (correctAnswers[3]);
                        GenerateBtn5.innerHTML = (wrongAnswers[8]);
                        timeLeft = timeLeft-100; //code to penalize user by deducting time from timer
                        })
                  ...
                  //below is code if users answers question 1 incorrectly *1st button*
                  ...
                  //above is code if user answers question 1 correctly *1st button*
                  //below is code if users answers question 1 incorrectly *2nd button*
                  ...
                  //above is code if user answers question 1 correctly *2nd button*
